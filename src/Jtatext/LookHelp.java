...
public class LookHelp extends JFrame{
	...
	public LookHelp(){
		...
		JLabel label1 = new JLabel("1、menu菜单栏的菜单项可点击来选择功能。");
		JLabel label2 = new JLabel("2、“view”里的剪切、复制、粘贴可用快捷键Ctrl + x、Ctrl + c、Ctrl + v实现。");
		JLabel label3 = new JLabel("3、“search”里的“自动换行”需要点中才可进行自动换行，否则会一直往后写。");
